...
check_contains "scripts/setup_builder_production_soak_launchd.sh" 'RUN_MODE=once FAIL_CLOSED=1 ALERT_ON_FAIL=1 BCAST_ON_FAIL=1' "missing_fail_closed_runner_binding"
...
check_contains "scripts/setup_builder_production_soak_launchd.sh" 'emit_builder_failure_bcast_alert.sh' "missing_bcast_alert_script_copy"
check_contains "scripts/setup_builder_production_soak_launchd.sh" 'set_builder_failure_alert_recipient.sh' "missing_bcast_routing_set_script_copy"
check_contains "scripts/setup_builder_production_soak_launchd.sh" 'ack_builder_failure_alert.sh' "missing_bcast_routing_ack_script_copy"
check_contains "scripts/setup_builder_production_soak_launchd.sh" "BCAST_ALERT_CMD='" "missing_bcast_alert_cmd_launchd_binding"
check_contains "scripts/setup_builder_production_soak_launchd.sh" "BCAST_ROUTING_FILE='" "missing_bcast_routing_file_launchd_binding"
check_contains "scripts/setup_builder_production_soak_launchd.sh" "BCAST_ACK_FILE='" "missing_bcast_ack_file_launchd_binding"
