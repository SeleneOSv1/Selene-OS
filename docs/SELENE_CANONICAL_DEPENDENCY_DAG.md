...
| 7 Wake, Side Button, And Activation Stack | activation packet foundation and consent baseline | wake/side-button activation packets | Stages 3-6 | Stage 8, native clients, Stage 34 | Stage 7A next. Wake opens/resumes only; iPhone no always-listening. |
