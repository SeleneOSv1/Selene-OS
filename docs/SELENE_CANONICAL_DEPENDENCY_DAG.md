...
| 11 Reasoning Orchestrator, Capability Registry, Tool Route | understanding packet | route candidate packet, task/model profile candidate | Stages 3, 10 | Stage 12, Stage 13, Stage 22, Stage 24 | Stage 11A is ready to start from non-executing Stage 10A understanding context. Cannot execute. |
