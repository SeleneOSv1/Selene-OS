...
| 5 Session Open, Resume, Close, And Runtime Turn Spine | activation/session/turn packets | current committed turn, conversation goal/open-loop state | Stage 4 | Stages 6, 8-12, 15, 21, 29, 34 | Stage 5A PROVEN_COMPLETE for session/current-turn authority, stale/superseded quarantine, record separation, and no-route-authority. Stage 5B must reconcile conversation control and same-page state before broad Stage 5 completion. |
...
| 7 Wake, Side Button, And Activation Stack | activation packet foundation and consent baseline | wake/side-button activation packets | Stages 3-6 | Stage 8, native clients, Stage 34 | Wake opens/resumes only; iPhone no always-listening. |
| 8 Voice I/O, Listen State, Transcript Gate | wake/explicit mic/live voice packets | audio scene, final transcript, interruption state | Stages 3-7 | Stages 9-10, 17, 34 | Broad stage; split into slices. |
