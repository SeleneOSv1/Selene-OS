...
- `Build Sections 01–11` -> [docs/BUILD_SECTIONS/](BUILD_SECTIONS/)
...
- Authoritative engine inventory + placements: `docs/07_ENGINE_REGISTRY.md`
- Simulation catalog (authoritative): `docs/08_SIMULATION_CATALOG.md`
- Blueprint registry (authoritative): `docs/09_BLUEPRINT_REGISTRY.md`
- DB ownership matrix (authoritative): `docs/10_DB_OWNERSHIP_MATRIX.md`
...
- Top-level orchestration/runtime class boundaries:
  ...
  - `docs/ECM/PH1_OS.md`
- Engine-level runtime contracts:
  - `docs/DB_WIRING/*.md`
  - `docs/ECM/*.md`
...
- Engine closure execution plan (active): `docs/34_ENGINE_CLOSURE_EXECUTION_PLAN.md`
