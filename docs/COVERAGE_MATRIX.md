...
| SELENE_OS_CORE_TABLES | docs/DB_WIRING/SELENE_OS_CORE_TABLES.md | docs/ECM/SELENE_OS_CORE_TABLES.md | [WORK_ORDER_APPEND_COMMIT, WORK_LEASE_ACQUIRE_COMMIT, WORK_LEASE_RENEW_COMMIT, WORK_LEASE_RELEASE_COMMIT, SCHED_NEXT_ACTION_DRAFT] | [] | DONE | DONE | WIP | NA | WorkOrder simulation triggers are cataloged; global no-repeat fields + external approval pending wait rules are documented (AT-OS-20/AT-OS-21), but blueprint trigger coverage is not yet defined in docs/BLUEPRINTS/*.md |
| PBS_TABLES | docs/DB_WIRING/PBS_TABLES.md | docs/ECM/PBS_TABLES.md | [] | [LINK_INVITE, LINK_DELIVER_INVITE, LINK_OPEN_ACTIVATE, ONB_INVITED, ONB_BIZ_SETUP, POSITION_MANAGE, CAPREQ_MANAGE] | DONE | DONE | NA | DONE | none |
...
| PH1.BCAST | docs/DB_WIRING/PH1_BCAST.md | docs/ECM/PH1_BCAST.md | [BCAST_CREATE_DRAFT, BCAST_DELIVER_COMMIT, BCAST_DEFER_COMMIT, BCAST_ACK_COMMIT, BCAST_ESCALATE_COMMIT, BCAST_EXPIRE_COMMIT, BCAST_CANCEL_COMMIT] | [MESSAGE_COMPOSE_AND_SEND, LINK_DELIVER_INVITE] | DONE | DONE | DONE | DONE | none (wired in `docs/06_ENGINE_MAP.md`: YES; BCAST.MHP locked: YES (SENT→WAITING→FOLLOWUP→REMINDER_SET→REMINDER_FIRED→CONCLUDED; phone-first)) |
