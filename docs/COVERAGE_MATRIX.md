...
| PH1.BCAST | docs/DB_WIRING/PH1_BCAST.md | docs/ECM/PH1_BCAST.md | [BCAST_CREATE_DRAFT, BCAST_DELIVER_COMMIT, BCAST_DEFER_COMMIT, BCAST_ACK_COMMIT, BCAST_ESCALATE_COMMIT, BCAST_EXPIRE_COMMIT, BCAST_CANCEL_COMMIT] | [] | DONE | DONE | DONE | NA | none (wired in `docs/06_ENGINE_MAP.md`: YES) |
| PH1.DELIVERY | docs/DB_WIRING/PH1_DELIVERY.md | docs/ECM/PH1_DELIVERY.md | [DELIVERY_SEND_COMMIT, DELIVERY_CANCEL_COMMIT] | [] | DONE | DONE | DONE | NA | none (wired in `docs/06_ENGINE_MAP.md`: YES) |
