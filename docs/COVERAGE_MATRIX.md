...
| PH1.POLICY | docs/DB_WIRING/PH1_POLICY.md | docs/ECM/PH1_POLICY.md | [] | [] | DONE | DONE | NA | NA | none (wired in `docs/06_ENGINE_MAP.md`: YES; ALWAYS_ON prompt/interrupt policy consult) |
