...
## 1. Eight-Document Architecture Set Verification
...
| G. Memory + Recall + Preference Stack | 8 | PH1.M, PH1.X, access/session | PARTIAL | Memory/access activation | 5 | Access-scoped memory recall baseline | Adapter memory shortcuts; current-vs-recent confusion. |
...
| 3 | Semantic Meaning Proposal Baseline | A, Quick Assist | PH1.X, PH1.D, providerctl, Adapter | GHCS activation | 4 | semantic packet skeleton; fake semantic provider; malformed proposal rejection; Quick Assist wording proposal shell | schema rejection, owner candidate not authority | yes/yes | no | PH1.X/Adapter deterministic helpers retained |
...
| 5 | PH1.WRITE Presentation Baseline | E, F, M, N, Quick Assist | PH1.WRITE, PH1.TTS, PH1.E presentation packet, clients | PH1.WRITE activation | 5 | display/tts split; one-line rewrite; style/format; Quick Assist final wording; raw provider output guard | formatted/display/tts evidence | yes/yes if provider wording | yes for visible text | deterministic formatting helpers retained |
...
| 8 | Memory Scope + Preference Boundary | G, Persona/Preference | PH1.M, access/session, persona/learn | Memory activation | 5 | private memory scope; current/recent; preference recall; memory write/update/forget; learning signal boundary | PH1.M evidence and denial refs | yes/yes if provider salience | yes for memory UX | Adapter memory shortcuts retained |
...
| 10 | Voice/Wake/Session/Realtime Route Proof | L, Quick Assist | PH1.W/C/L/TTS, Voice ID, Adapter http/bin, Desktop/iPhone | Voice route activation | 6 | transcript admission; realtime/off proof; TTS approved text; wake acknowledgement via Quick Assist; barge-in; real app route proof | transcript/session/tts/Desktop provenance | yes/yes | yes | local STT/TTS fallback claims retained fail-closed |
...
| 18 | Persona/Preference/Emotion/Feedback/Learning | Persona stack, G | PH1.PERSONA, EMO, FEEDBACK, LEARN, M | Persona activation | 5 | persona hints; emotion guide; feedback capture; learning signal; preference permission | identity-scoped evidence | yes/yes | yes | no private personalization for unknown speaker |
...
1. Unknown-speaker private memory denial.
2. Confirmed-access scoped memory recall.
3. Current/recent/durable boundary proof.
4. Preference application with memory law.
5. Learning/feedback signal boundary.
...
| Phase 5 PH1.WRITE/Quick Assist | PH1.WRITE tests | PH1.X -> PH1.WRITE | yes if provider wording | yes | WriteOutput/formatted_text refs | yes | visible text/TTS |
...
| Phase 10 Voice/Realtime | PH1.W/L/TTS/adapter tests | Desktop/iPhone voice route | yes | yes | transcript/session/tts/client refs | yes | real app voice |
...
| Phase 18 Persona/Learning | persona/emo/feedback/learn/memory tests | preference route | yes | yes | memory/preference refs | yes | personalization allow/deny |
...
6. Build PH1.WRITE Display / TTS / Source Presentation Baseline
7. Build Live One-Line Follow-Up Routing To PH1.X / PH1.WRITE
8. Build PH1.M Access-Scoped Memory Boundary
9. Build PH1.E Source Acceptance / Source Chips / Provider-Off Search Proof
10. Build Old Compatibility Path Active-Caller Ledger
