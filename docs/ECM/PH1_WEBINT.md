...
### capability_id: WEBINT_EVIDENCE_EXTRACT
...
- reason_codes: PH1_WEBINT_INPUT_SCHEMA_INVALID, PH1_WEBINT_UPSTREAM_INPUT_MISSING, PH1_WEBINT_BUDGET_EXCEEDED, PH1_WEBINT_INTERNAL_PIPELINE_ERROR

### capability_id: WEBINT_SOURCE_RANK
...
- reason_codes: PH1_WEBINT_VALIDATION_FAILED, PH1_WEBINT_INPUT_SCHEMA_INVALID, PH1_WEBINT_BUDGET_EXCEEDED
