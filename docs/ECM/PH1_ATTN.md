...
### capability_id: ATTN_FOCUS_SCORE
...
- reason_codes: PH1_ATTN_INPUT_SCHEMA_INVALID, PH1_ATTN_UPSTREAM_INPUT_MISSING, PH1_ATTN_BUDGET_EXCEEDED, PH1_ATTN_INTERNAL_PIPELINE_ERROR

### capability_id: ATTN_SPAN_PRIORITY_BUILD
...
- reason_codes: PH1_ATTN_VALIDATION_FAILED, PH1_ATTN_INPUT_SCHEMA_INVALID, PH1_ATTN_BUDGET_EXCEEDED
