...
- Stage 34N is now PROVEN_COMPLETE for controlled STT/listening proof; no wake behavior was reopened, iPhone activation remains explicit side-button only, and the post-Stage-34N closure-map refresh keeps broad Stage 34 blocked while authorizing `Stage 34O - TTS Naturalness Controlled Proof` as the next exact narrowed Stage 34 build.
