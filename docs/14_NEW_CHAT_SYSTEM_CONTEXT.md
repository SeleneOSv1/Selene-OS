...
- PH1.E `blueprints_referenced_by = [TOOL_TIME_QUERY, TOOL_WEATHER_QUERY, TOOL_WEB_SEARCH, TOOL_NEWS, TOOL_URL_FETCH_AND_CITE, TOOL_DOCUMENT_UNDERSTAND, TOOL_PHOTO_UNDERSTAND]`
- PH1.E blockers none
