...
| TOOL_RECORD_MODE | TOOL_RECORD_MODE | v1 | ACTIVE | `docs/BLUEPRINTS/TOOL_RECORD_MODE.md` |
| TOOL_CONNECTOR_QUERY | TOOL_CONNECTOR_QUERY | v1 | ACTIVE | `docs/BLUEPRINTS/TOOL_CONNECTOR_QUERY.md` |
