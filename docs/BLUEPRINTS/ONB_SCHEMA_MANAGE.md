...
| ONB_SCHEMA_S09 | PH1.ONB | PH1ONB_BACKFILL_START_DRAFT_ROW | when apply_scope=CURRENT_AND_NEW: actor_user_id, tenant_id, company_id, position_id, schema_version_id, rollout_scope=CURRENT_AND_NEW, idempotency_key | backfill_campaign_id, backfill_state, pending_target_count | DB_WRITE (simulation-gated) | 700 | 2 | 250 | [ONB_BACKFILL_START_RETRYABLE] |
