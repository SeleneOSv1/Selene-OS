...
|---|---|---|---|---|---|---:|---:|---:|---|
| WEATHER_S01 | PH1.E | PH1E_TOOL_WEATHER_QUERY | tenant_id, correlation_id, turn_id, user_id, device_id, tool_name=WEATHER, query_hash, cache_status, reason_code | tool_response | READ_ONLY | 250 | 1 | 100 | [E_FAIL_TIMEOUT] |
| WEATHER_S02 | PH1.X | PH1X_TOOL_RESPONSE_RENDER | tool_response | response_text | READ_ONLY | 250 | 1 | 100 | [OS_RESPONSE_RETRYABLE] |

Notes:
- The actual weather lookup is performed by the read-only tool router.
