...
- Offline-only constraint: never invoked in-turn; produces artifact proposals only.

## D) Wiring
- Invoked_by: OS offline pipeline step: batch pattern mining
- Inputs_from: PH1.J audit/event exports, PH1_LISTEN historical signals
- Outputs_to: pattern_proposals returned to Selene OS offline artifact queue
...
## E) Acceptance Tests
- AT-PATTERN-01: Selene OS can invoke capability_id and output is schema-valid.
