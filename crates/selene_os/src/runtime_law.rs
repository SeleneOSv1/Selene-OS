...
mod tests {
    ...
    #[test]
    fn at_runtime_law_17_unsupported_client_platform_compatibility_blocks_protected_execution() {
        let runtime = RuntimeLawRuntime::default();
        let mut envelope = base_envelope();
    ...
    #[test]
    fn at_runtime_law_18_untrusted_device_platform_compatibility_blocks_protected_execution() {
        let runtime = RuntimeLawRuntime::default();
        let mut envelope = base_envelope();
        ...
        envelope.platform_context.device_trust_class = DeviceTrustClass::UntrustedDevice;
        envelope.platform_context.integrity_status = ClientIntegrityStatus::IntegrityVerified;
        envelope.platform_context.compatibility_status = ClientCompatibilityStatus::Compatible;
    ...
    #[test]
    fn at_runtime_law_20_integrity_unknown_platform_trust_degrades_protected_execution() {
        let runtime = RuntimeLawRuntime::default();
        let mut envelope = base_envelope();
        ...
        envelope.platform_context.device_trust_class = DeviceTrustClass::StandardDevice;
        envelope.platform_context.integrity_status = ClientIntegrityStatus::Unknown;
        envelope.platform_context.compatibility_status = ClientCompatibilityStatus::Compatible;

        envelope
            .validate()
            .expect("integrity-unknown envelope must remain contract-valid");
