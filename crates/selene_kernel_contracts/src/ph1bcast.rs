...
pub const BCAST_POLICY_UPDATE_COMMIT: &str = "BCAST_POLICY_UPDATE_COMMIT";
pub const BCAST_WAIT_POLICY_UPDATE_COMMIT: &str = "BCAST_WAIT_POLICY_UPDATE_COMMIT";
pub const BCAST_URGENT_FOLLOWUP_POLICY_UPDATE_COMMIT: &str =
    "BCAST_URGENT_FOLLOWUP_POLICY_UPDATE_COMMIT";
pub const BCAST_DEFAULT_NON_URGENT_WAIT_SECONDS: u32 = 300;
pub const BCAST_DEFAULT_URGENT_FOLLOWUP_IMMEDIATE: bool = true;
pub const BCAST_DEFAULT_MAX_FOLLOWUP_ATTEMPTS: u32 = 1;
pub const BCAST_NON_URGENT_FOLLOWUP_WINDOW_NS: u64 =
    (BCAST_DEFAULT_NON_URGENT_WAIT_SECONDS as u64) * 1_000_000_000;
