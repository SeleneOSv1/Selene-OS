...
Current Project Phase and Lane Law
...
Architectural Boundary: Probabilistic Public Answer vs Deterministic Protected Execution

Selene has two primary operating lanes.

Lane 1 — PROBABILISTIC_PUBLIC_ANSWER
...
Lane 2 — DETERMINISTIC_PROTECTED_EXECUTION
...
Intent and Execution Clarification
...
“Draft a P&L template.”

Lane: PROBABILISTIC_PUBLIC_ANSWER

“Analyze these uploaded numbers and draft a P&L summary.”

Lane: PROBABILISTIC_PUBLIC_ANSWER

“Run the official company P&L from accounting records.”

Lane: DETERMINISTIC_PROTECTED_EXECUTION

Draft vs Official Execution Rule
...
“Submit the report to directors.”
...
Tool Retrieval and Provider Degradation Rule
...
Probabilistic Presentation and Preference Adaptation Rule
...
If the user prefers time in 12-hour or 24-hour format, Selene should follow that preference where memory law allows.
...
User: “What’s the weather today? Keep it short.”

Correct: short weather answer.

Wrong: fixed long deterministic weather report.

User: “Explain the news to me and keep it short.”

Correct: short public news summary.

Wrong: rigid fixed report format.

User: “From now on, give me weather in short bullet points.”

Correct: remember this as a presentation preference if memory law allows.

User: “What time is it? Use 24-hour time.”

Correct: answer using the requested time format where available.
...
Apply now in the current answer.

“From now on, give weather in short bullet points.”

Store only if memory law allows.

“Use 24-hour time for me.”
...
Simulation Transition Authorization Rule
...
Mandatory Codex Lane Declaration
...
PROBABILISTIC_FOUNDATION_BUILD

or SIMULATION_EXECUTION_BUILD if JD explicitly authorizes simulation work

selected lane:

PROBABILISTIC_PUBLIC_ANSWER

DETERMINISTIC_PROTECTED_EXECUTION
...
yes/no and for which part

Codex must stop before editing if it cannot classify the lane.

Standing Stop Rules for Lane Misclassification

Stop if:

Codex applies deterministic simulation gates to ordinary public chat/search/research without JD explicitly authorizing deterministic execution work

Codex blocks harmless public answers because no simulation exists

Codex blocks harmless public answers because an unrelated provider degraded

Codex weakens protected/business fail-closed behavior

Codex mixes public answer and protected execution without separating them

Codex allows protected execution through the probabilistic lane

Codex treats provider failure as protected execution failure

Codex claims deterministic execution for advisory/probabilistic output

Codex converts a probabilistic capability into deterministic simulation work without JD authorization

Standing Build Rule

During PROBABILISTIC_FOUNDATION_BUILD:

normal chat/search/language/research/reporting is probabilistic by default

time/weather/news/search presentation is probabilistic and user-adaptive by default

drafts, advisory reports, explanations, summaries, and user-provided data analysis are probabilistic by default

read-only public tool/provider retrieval is not protected simulation execution

provider degradation must not block a normal public/advisory answer if a degraded answer or alternate public source is available

protected business execution remains blocked unless a simulation exists

official company-data execution requires deterministic simulation authority

“No Simulation -> No Execution” means no protected execution, not no answer
